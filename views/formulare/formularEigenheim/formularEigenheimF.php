...
if (agree)
	...
	return false ;
			...
			<div class="vorschaufenster" >
				...
				<div class="view-formularAdmin-vorschau-nummern"><?php if ($mobile != "") { echo 'Mobile '; echo $mobile; echo ' · '; } if ($phone != "") { echo ' T�l�phone '; echo $phone; } if ($fax != "") {  echo ' � Fax '; echo $fax; } ?></div>
			</div>
		</div>
	</body>
</html>
